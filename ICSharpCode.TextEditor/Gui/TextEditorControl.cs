...
namespace ICSharpCode.TextEditor
{
	...
	public class TextEditorControl : TextEditorControlBase
	{
		...
		public void setSelectionChangedEvent()
		{
			if (SelectionChanged != null)
			{
				activeTextAreaControl.TextArea.SelectionManager.SelectionChanged += SelectionChanged;
			}
		}
		
		public void setPositionChangedEvent()
		{
			if (PositionChanged != null)
			{
				activeTextAreaControl.TextArea.Caret.PositionChanged += PositionChanged;
			}
		}
